...
async function main() {
  ...
  try {
    ...
    try {
      ...
      console.log(`\n🔄 Checking if ${sourceDir} is a git repository...`);
      
      // Check if it's a git repository
      execSync('git rev-parse --is-inside-work-tree', { cwd: sourceDir, stdio: 'ignore' });
      
      console.log(`📂 ${sourceDir} is a git repository. Updating to latest main branch...`);
      ...
      console.log(`✅ Successfully updated to latest main branch`);
    } catch (error) {
